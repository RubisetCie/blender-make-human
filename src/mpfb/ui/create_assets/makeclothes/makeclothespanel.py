...
class MPFB_PT_MakeClothes_Panel(Abstract_Panel):
    ...
    def _check_clothes(self, blender_object, scene, layout):
        ...
        if not CLOTHES_CHECKS or uuid_value not in CLOTHES_CHECKS:
            ...
            for check_label in ['is_valid_object', 'has_any_vertices', 'has_any_vgroups', 'all_verts_have_max_one_vgroup', 'all_verts_have_min_one_vgroup', 'all_verts_belong_to_faces', 'all_faces_same_type', 'clothes_groups_exist_on_basemesh', 'objs_same_scale', 'all_checks_ok']:
